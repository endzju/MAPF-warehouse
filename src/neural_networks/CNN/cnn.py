...
class CNN_16k3_32k3(nn.Module):
    def __init__(self, view_shape, goal_vec_size, n_actions):
        super(CNN_16k3_32k3, self).__init__()
...
class CNN_32k3_64k3(nn.Module):
    def __init__(self, view_shape, goal_vec_size, n_actions):
        super(CNN_32k3_64k3, self).__init__()
        self.cnn = nn.Sequential(
            nn.Conv2d(view_shape[0], 32, kernel_size=3, padding=1),
            nn.ReLU(),
            nn.Conv2d(32, 64, kernel_size=3, padding=1),
...
class CNN_64k3_128k3(nn.Module):
    def __init__(self, view_shape, goal_vec_size, n_actions):
        super(CNN_64k3_128k3, self).__init__()
        self.cnn = nn.Sequential(
            nn.Conv2d(view_shape[0], 32, kernel_size=3, padding=1),
            nn.ReLU(),
            nn.Conv2d(32, 64, kernel_size=3, padding=1),
...
class CNN_128k3_256k3(nn.Module):
    def __init__(self, view_shape, goal_vec_size, n_actions):
        super(CNN_128k3_256k3, self).__init__()
        self.cnn = nn.Sequential(
            nn.Conv2d(view_shape[0], 32, kernel_size=3, padding=1),
            nn.ReLU(),
            nn.Conv2d(32, 64, kernel_size=3, padding=1),
