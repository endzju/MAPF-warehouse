...
def run_experiments(force_train: bool = True, eval: bool = True):
    ...
    variations = [
        ...
        },
        {
            ...
            "view_size": [7],
            "num_batches": [90, 95, 100, 105, 110, 115],
            "batch_size": [4096 * 2],
            "num_episodes": [1500],
            "suffix": ["search1"],
            "step_limit": [900],
        ...
        },
        {
            ...
            "num_episodes": [1500],
            "suffix": ["search1"],
            "step_limit": [600, 800, 1000, 1200, 1400],
            "target_update_interval": [60],
            "buffer_length": [500_000],
            "float_goal_vector": [True],
        },
        ...
        },
        {
            ...
            "suffix": ["search1"],
            "step_limit": [900],
            "target_update_interval": [30, 40, 50, 60, 70, 80, 90, 100],
            "buffer_length": [500_000],
            "float_goal_vector": [True],
        },
        {
            ...
            "batch_size": [4096 * 8],
            "num_episodes": [1500],
            "suffix": ["search1", "search2", "search3"],
            "step_limit": [900],
            "target_update_interval": [60],
            "buffer_length": [500_000],
            "float_goal_vector": [True],
